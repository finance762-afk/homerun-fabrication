 ...
 */
$ppSlug = isset($partnerProfileSlug) && $partnerProfileSlug !== '' ? (string) $partnerProfileSlug : 'homerun-fabrication-llc-amarillo-tx';
$ppName = isset($partnerProfileName) && $partnerProfileName !== '' ? (string) $partnerProfileName : 'Homerun Fabrication LLC';
